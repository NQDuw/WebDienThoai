...
namespace WebDienThoai.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        {
            [Required(ErrorMessage = "Chưa nhập Email"), StringLength(200)]
            [EmailAddress(ErrorMessage = "Nhập kiểu Email không đúng")]
            [Display(Name = "Email")]
            ...
            [Compare("Password", ErrorMessage = "Mật Khẩu và mật khẩu nhập lại đúng")]
